...
export function groundHeight(z:number) {
 // A missed jump drops into a slower route with a physical exit, never a reset loop.
 if(z>87 && z<94) return base(z) - 1.6 * (94-z) / 7;
...
for(let i=1;i<elevations.length;i++) {
 ...
 if(a===87 && b===94) {ramp('trench-exit',a,b,-1.6,0); continue;}
 if(a===148 && b===157){ for(const [i,x] of LANE_CENTERS.entries())ramp('wonky-'+i,a,b,h,k,3.45,x,.045,0x66765a); }
