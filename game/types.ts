...
export interface VehicleSnapshot extends Pose { id: PlayerId; wheels: Pose[]; speed: number; progress: number; charge: number; grounded: boolean; recovering: boolean; finished: boolean; finishTime: number | null; flips: number; recoveries: number; jumps: number; maxRoll: number; blueprint: Blueprint }
